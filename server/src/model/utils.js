...
const floorDecimal = (num, dec) => Math.round((num + Number.EPSILON) * 10 ** dec) / 10 ** dec;

module.exports = { DocumentProcessor, floorDecimal };
